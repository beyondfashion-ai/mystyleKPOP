...
3.  **Booster:** Uses ⭐ Boost (currency) to expose their favorite outfit at the top.
...
- However, for trust, **Like (Free/1 person 1 vote)** and **Boost (Paid/Exposure)** are strictly **displayed separately**.
