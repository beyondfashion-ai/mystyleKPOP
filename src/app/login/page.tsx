            ...
            <div className="flex-1 flex flex-col justify-center items-center px-6 py-12">
                ...
                <div className="w-full max-w-[360px]">
                    <div className="flex mb-8 bg-gray-50 rounded-xl p-1">
                        <button
                            ...
                            className={`flex-1 py-2.5 text-[13px] font-bold rounded-lg transition-all ${
                                mode === "login" ? "bg-black text-white shadow-sm" : "text-gray-400 hover:text-black"
                            }`}
                        >
                            로그인
                        </button>
                        <button
                            ...
                            className={`flex-1 py-2.5 text-[13px] font-bold rounded-lg transition-all ${
                                mode === "signup" ? "bg-black text-white shadow-sm" : "text-gray-400 hover:text-black"
                            }`}
                        >
                            회원가입
                        </button>
                    ...
                    <button
                        ...
                        disabled={isLoading || isGoogleLoading}
                        className="w-full flex items-center justify-center gap-3 py-3.5 bg-white border border-gray-200 rounded-xl text-[14px] font-medium hover:border-black hover:shadow-sm transition-all disabled:opacity-60 disabled:cursor-not-allowed"
                    >
                        {isGoogleLoading ? (
                    ...
                    <p className="text-center text-[10px] text-gray-300 mt-6">관리자: admin@mystyle.ai</p>
                </div>
            </div>

            <footer className="py-6 text-center">
                <p className="text-[10px] text-gray-300">© 2025 MY-STYLE.AI · All rights reserved</p>
            </footer>
        </div>
    );
}
